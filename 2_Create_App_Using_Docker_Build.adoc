...
time      time-jimgarrett.apps.rhpds.openshift.opentlc.com             time       8080-tcp                 None
....
...
....
$ curl http://time-jimgarrett.apps.rhpds.openshift.opentlc.com
...
link:3_Using_Web_Console.adoc[Next Lab]
